...
public class wr_comment extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String token = null;
		int a_id;
		if(request.getParameter("name")!=null && request.getParameter("token")!=null&&request.getParameter("a_id")!=null){
			...
			try {
				...
				if(tok!=null&&tok!="0"){
					if(tok.equals(token)){
						...
						boolean f = ad.create_coms(com, a_id);
						res.put("create", f);
					}
				}else{
					res.put("admin",false);
